  ...
  return (
    <div>
            ...
            <div className="product-info">
              <div className="info-wrapper">
                <div className="homepageDeal left-to-right">
                  <h1 className="blink_me">HOT ITEM THIS WEEK</h1>
                </div>
      ...
      <div className="container mt-3">
        <h2 className="homepageTitle" style={{ paddingTop: "15px" }}>
          CATEGORY
        </h2>
        <div className="categorySelect">
          <div className="row">
            <div
              className="categoryItem col-md-4 col-sm-4 col-xs-12"
            ...
            <div
              className="categoryItem col-md-4 col-sm-4 col-xs-12"
              onClick={() => setCategory("Phones and Accessories")}
            >
              <div className="innerCategoryItem">
                <img src={phone} />
              </div>
            ...
            <div
              className="categoryItem col-md-4 col-sm-4 col-xs-12"
              onClick={() => setCategory("Electronic device")}
            >
              <div className="innerCategoryItem">
                <img src={tv} />
              </div>
            ...
            <div
              className="categoryItem col-md-4 col-sm-4 col-xs-12"
              onClick={() => setCategory("Household goods")}
            >
              <div className="innerCategoryItem">
                <img src={house} />
              </div>
            ...
            <div
              className="categoryItem col-md-4 col-sm-4 col-xs-12"
              onClick={() => setCategory("Home and Life")}
            >
              <div className="innerCategoryItem">
                <img src={household} />
              </div>
            ...
            <div
              className="categoryItem col-md-4 col-sm-4 col-xs-12"
              onClick={() => setCategory("Health and Life")}
            >
              <div className="innerCategoryItem">
                <img src={health} />
              </div>
            ...
            <div
              className="categoryItem col-md-4 col-sm-4 col-xs-12"
              onClick={() => setCategory("Fashion Accessories")}
            >
              <div className="innerCategoryItem">
                <img src={accessories} />
              </div>
